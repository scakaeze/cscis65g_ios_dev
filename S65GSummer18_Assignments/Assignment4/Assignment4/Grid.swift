...
let GridNoticationName = Notification.Name(rawValue: "GridUpdate")
...
protocol EngineDelegate {
    func engine(didUpdate: EngineProtocol) -> Void
}
...
class StandardEngine: EngineProtocol{
    ...
    static var onlyInstance = StandardEngine(10, 10)
    ...
    var grid: Grid {
        didSet {
            ...
            let info = ["grid":self]
            broadcast.post(name: GridNoticationName, object: nil, userInfo: info)
        }
    }
